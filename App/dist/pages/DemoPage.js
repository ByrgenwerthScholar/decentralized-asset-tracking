...
const AlignVerticalCenter_1 = __importDefault(require("@mui/icons-material/AlignVerticalCenter"));
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(material_1.Box, { sx: {
            ...
            react_1.default.createElement(material_1.Box, { sx: { display: 'flex', alignItems: 'center', mb: 2 } },
                react_1.default.createElement(AlignVerticalCenter_1.default, { sx: { mr: 1, fontSize: 30, color: 'text.primary' } }),
