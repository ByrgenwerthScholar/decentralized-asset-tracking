...
const DocsPage = () => {
    return (react_1.default.createElement(material_1.Box, { sx: { display: 'flex', height: '100vh' } },
        react_1.default.createElement(material_1.Box, { sx: {
            ...
            react_1.default.createElement(material_1.Typography, { variant: "h6", sx: { color: 'white', mb: 2 } }, "Docs Chapters"),
            react_1.default.createElement(material_1.List, null, chapters.map((chapter) => (react_1.default.createElement(material_1.ListItem, { key: chapter.id, disablePadding: true },
                react_1.default.createElement(material_1.ListItemButton, { component: react_router_dom_1.Link, to: `/docs/${chapter.id}`, sx: { color: 'white' } },
        ...
        react_1.default.createElement(material_1.Box, { sx: { flexGrow: 1, p: 3, mt: '80px', ml: '240px' } },
            react_1.default.createElement(react_router_dom_1.Routes, null,
                ...
                react_1.default.createElement(react_router_dom_1.Route, { path: ":chapterId", element: react_1.default.createElement(DocsContent, null) })))));
};
